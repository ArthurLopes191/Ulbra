...
insert into vendas (id, id_vendedor, data_venda) values (10, 1, '2022-11-20');
...
/*Mostrar vendedor que vendeu mais*/
select max(quantidade_vendas) from (
...
/*Mostrar uma listagem dos produtos que possuem ao menos duas vendas*/
